...
Automated ETL pipeline built with Apache Airflow, PySpark, Docker, and AWS S3 to extract trending YouTube video data using the YouTube Data API, preprocess and transform datasets, and store processed data in cloud storage for analytics and visualization.
